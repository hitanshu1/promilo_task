            ...
            child: Row(
              ...
              children: [
                ...
                _bottomBarIcon(
                    ...
                    onTap: () {
                      context.read<DashBoardBloc>().add(const ChangeTabDashBoardEvent(3));
                    }),
                _bottomBarIcon(
                    ...
                    onTap: () {
                      context.read<DashBoardBloc>().add(const ChangeTabDashBoardEvent(4));
                    }),
              ],
            ),
          ),
